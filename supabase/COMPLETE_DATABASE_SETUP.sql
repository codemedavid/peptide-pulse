...
-- ============================================================================
-- Run this SINGLE file in your Supabase SQL Editor after cloning the project
-- This creates ALL tables, functions, buckets, policies, and seed data
...
-- ============================================
-- SECTION 4: PRODUCT VARIATIONS TABLE
-- ============================================
...
-- ============================================
-- SECTION 6: PAYMENT METHODS TABLE
-- ============================================
...
-- ============================================
-- SECTION 7: SHIPPING LOCATIONS TABLE
-- ============================================
...
CREATE TABLE IF NOT EXISTS public.orders (
    ...
    shipping_provider TEXT DEFAULT 'jnt',
...
-- ============================================
-- SECTION 12: ASSESSMENT RESPONSES TABLE
-- ============================================
...
-- ============================================
-- SECTION 13: ORDER TRACKING FUNCTION
-- ============================================
...
-- ============================================
-- SECTION 14: SAMPLE TIRZEPATIDE PRODUCTS
-- ============================================
...
-- ============================================
-- SECTION 15: PRODUCT VARIATIONS FOR TIRZEPATIDE
-- ============================================
...
-- Create menu-images bucket (Product Images)
...
-- Create payment-proofs bucket (Payment Screenshots)
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES (
  'payment-proofs',
  'payment-proofs',
...
-- Create coa-images bucket (COA Lab Reports)
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES (
  'coa-images',
  'coa-images',
...
-- Create article-covers bucket (Blog/Guide Cover Images)
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES (
  'article-covers',
  'article-covers',
...
-- Policies for article-covers bucket
...
DROP POLICY IF EXISTS "Anyone can upload article covers" ON storage.objects;
CREATE POLICY "Anyone can upload article covers"
ON storage.objects FOR INSERT TO public
WITH CHECK (bucket_id = 'article-covers');

DROP POLICY IF EXISTS "Anyone can update article covers" ON storage.objects;
CREATE POLICY "Anyone can update article covers"
ON storage.objects FOR UPDATE TO public
USING (bucket_id = 'article-covers')
WITH CHECK (bucket_id = 'article-covers');

DROP POLICY IF EXISTS "Anyone can delete article covers" ON storage.objects;
CREATE POLICY "Anyone can delete article covers"
ON storage.objects FOR DELETE TO public
USING (bucket_id = 'article-covers');


-- ============================================
-- SECTION 17: REFRESH SCHEMA CACHE
-- ============================================
...
-- ============================================
-- SECTION 18: VERIFICATION - CHECK ALL TABLES
-- ============================================
...
UNION ALL
SELECT 'assessment_responses', COUNT(*) FROM public.assessment_responses;

-- Check storage buckets
SELECT id, name, public FROM storage.buckets 
WHERE id IN ('menu-images', 'payment-proofs', 'coa-images', 'article-covers')
ORDER BY id;
...
-- 1. All tables created (check the SELECT results above)
-- 2. Storage buckets created (menu-images, payment-proofs, coa-images, article-covers)
-- 3. Sample products and categories seeded
-- 4. FAQs and payment methods seeded
-- 
-- Next steps:
-- 1. Update your .env file with your Supabase credentials
-- 2. Run: npm install && npm run dev
-- 3. Access admin dashboard at /admin (password from .env)
-- ============================================
